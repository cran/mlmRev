...
system.time(Cm4 <- lmer(use ~ age+urban+livch+(urban|district),
                        Contraception, binomial))
Cm4
system.time(Cm5 <- lmer(use ~ age+urban+livch+(urban|district),
                        Contraception, binomial,
                        method = "Laplace"))
Cm5
@
...
<<children>>=
Contraception$children <- factor(ifelse(Contraception$livch == 0, "N", "Y"))
(Cm7 <- lmer(use ~ age + I(age^2) + urban + children + (1|district),
             Contraception, binomial, method = "Laplace"))
anova(Cm6, Cm7)
@
...
<<Cm9>>=
(Cm9 <- lmer(use ~ age + I(age^2) + urban + children + (urban|district),
             Contraception, binomial, method = "Laplace"))
anova(Cm7, Cm9)
(Cm10 <- lmer(use ~ age + I(age^2) + urban + children + (children|district),
             Contraception, binomial, method = "Laplace"))
anova(Cm7, Cm10)
@
...
##(Cm11 <- lmer(use ~ age + I(age^2) + urban + children + (1|district), Contraception, binomial, method = "Laplace"))
